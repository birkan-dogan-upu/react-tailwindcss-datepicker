...
const Input = () => {
    ...
    const getClassName = useCallback(() => {
        ...
        const defaultInputClassName = `relative transition-all duration-300 py-2.5 pl-4 pr-14 w-full border-gray-300 rounded-lg tracking-wide font-light text-sm placeholder-gray-400 bg-white focus:ring disabled:opacity-40 disabled:cursor-not-allowed ${border} ${ring}`;
    ...
    const getToggleClassName = useCallback(() => {
        ...
        const defaultToggleClassName =
            "absolute right-0 h-full px-3 text-secondary-400 focus:outline-none disabled:opacity-40 disabled:cursor-not-allowed";
